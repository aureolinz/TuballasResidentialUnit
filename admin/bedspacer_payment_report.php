		...
		<div class="card">
			<div class="card-body">
				<div class="col-md-12">
					...
					<div id="report">
						<div class="on-print">
							 <p><center>Bedspacer Payments Report</center></p>
						...
						<div class="row table-responsive">
							<table class="table table-bordered">
								...
								<tbody>
									...
									$i = 1;
									$tamount = 0;
									$payments  = $conn->query("SELECT p.*,concat(t.lastname,', ',t.firstname,' ',t.middlename) as name,h.house_no FROM payments p inner join tenants t on t.id = p.tenant_id inner join houses h on h.id = t.house_id where date_format(p.payment_date,'%Y-%m') = '$month_of' AND p.status = 2 AND t.type = 'Bedspacer' order by unix_timestamp(date_created) asc");
